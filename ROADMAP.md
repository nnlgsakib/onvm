...
- [ ] Node health reporting and metrics: liveness/ready endpoints, capacity metrics (CPU/mem/queue/GPU), tracing spans
...
## Phase 3: GPU & High-Performance Execution (3–5 milestones)
...
## Phase 4: Incentives & Settlements (4–6 milestones)
...
## Phase 5: Network & Consensus Hardening (6–7 milestones)
...
## Phase 6: Security, UX, and Marketplace (7–8 milestones)
